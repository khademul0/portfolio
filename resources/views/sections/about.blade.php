<section id="about" class="py-20 md:py-28">
  <div class="mx-auto max-w-6xl px-4">
    <div class="grid md:grid-cols-2 gap-10 items-start">
      <div>
        <p class="text-sm font-semibold text-slate-500 dark:text-slate-300 anim-about-text">ABOUT</p>
        <h2 class="mt-3 text-3xl md:text-4xl font-semibold tracking-tight anim-about-text">
          I build clean systems and polished UI.
        </h2>
        <p class="mt-5 text-slate-600 dark:text-slate-300 leading-relaxed anim-about-text">
      ...
      <div class="relative">
        ...
        <div class="space-y-8">
          @foreach($milestones ?? [] as $m)
            <div class="relative pl-12 anim-timeline-item">
    ...
    {{-- Skills --}}
    <div class="mt-16">
      <h3 class="text-xl font-semibold anim-about-text">Skills</h3>

      <div class="mt-6 grid md:grid-cols-2 gap-6">
        @foreach($skills ?? [] as $skill)
          <div class="rounded-2xl border border-slate-200 dark:border-white/10 p-5 anim-skill-card hover:-translate-y-1.5 hover:shadow-xl hover:shadow-indigo-500/10 hover:border-indigo-500/30 transition-all duration-300 cursor-default">
